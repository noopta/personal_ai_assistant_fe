...
export default function ColorVariant({ theme }: ColorVariantProps) {
  return (
    <div className={`${theme} min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary selection:text-white`}>
      <Navbar />
      <main>
        <Hero />
        <TrustedBy />
